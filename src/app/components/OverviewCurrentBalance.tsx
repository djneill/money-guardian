...
export default function OverviewCurrentBalance() {
    return (
        <div className='flex flex-col sm:flex-row items-center sm:my-8 sm:gap-3'>
            <div className='flex flex-col bg-grey-900 text-white w-full h-28 rounded-lg justify-center gap-4 px-4 mt-8 sm:mt-0'>
                <p className='text-preset-4'>Current Balance</p>
                <p className='text-preset-1'>{currencyFormat(data.balance.current)}</p>
            </div>

            <div className="flex flex-col bg-white w-full h-28 rounded-lg justify-center gap-4 px-4 mt-3 sm:mt-0">
